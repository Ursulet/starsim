...
export default async function Page({
  ...
  return (
    <section>
      <div>
        <h1 className="text-3xl font-bold text-starsim-navy">Doneaza</h1>
        <p className="mt-2 max-w-3xl text-slate-500">Editeaza pagina de donatii, datele bancare si sumele recomandate.</p>
      </div>
      {params?.updated ? (
        <div className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-semibold text-emerald-800">
          Datele pentru donatii au fost salvate.
        </div>
      ) : null}
      <div className="mt-8">
