...
export default async function ContactPage() {
  ...
  return (
    <>
      <PageHero title="Scrie-ne" eyebrow="Contact" intro={contact?.introText || "Suntem aici pentru programe, evenimente, voluntariat și parteneriate."} />
      <section className="section-padding"><Container className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
        <div className="premium-card p-6">
          ...
          <div className="mt-6 space-y-4 text-starsim-muted">
            ...
            <p className="flex gap-3"><MapPin className="h-5 w-5 text-starsim-gold" /> {contact?.address || "București, România"}</p>
